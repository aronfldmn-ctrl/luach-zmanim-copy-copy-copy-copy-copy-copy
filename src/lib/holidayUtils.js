...
export const HOLIDAY_NAMES = {
  ...
  'Isru Chag Pesach': { en: 'Isru Chag Pesach', heb: 'איסרו חג פסח' },
  'Isru Chag Sukkot': { en: 'Isru Chag Sukkot', heb: 'איסרו חג סוכות' },
  'Isru Chag Shavuot': { en: 'Isru Chag Shavuot', heb: 'איסרו חג שבועות' },
...
export const HOLIDAY_CATEGORIES_MAP = {
  ...
  'Isru Chag Pesach': HOLIDAY_CATEGORIES.MINOR,
  'Isru Chag Sukkot': HOLIDAY_CATEGORIES.MINOR,
  'Isru Chag Shavuot': HOLIDAY_CATEGORIES.MINOR,
